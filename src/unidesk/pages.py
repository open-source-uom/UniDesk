...
PAGES = {
    "Introduction": {
        "body": (
            ...
            "by the Open Source UoM community."
        ),
    },
    "Features": {
        "body": (
    ...
    "FAQ": {
        "body": (
            "Q: Can I install UniOS alongside Windows?\n"
            "A: Yes, the installer supports dual boot.\n\n"
    ...
    "Community": {
        "body": (
            "UniOS is built by students, for students.\n\n"
            "Join the Open Source UoM community to:\n"
            "• Get help and support from fellow students\n"
            "• Share tips, tweaks, and configurations\n"
            "• Participate in workshops and coding events\n"
            "• Stay updated on new releases and features\n\n"
            "You can find us on Discord — the invite link is in the footer.\n"
    ...
    "Contribute": {
        "body": (
            "Want to help build UniOS? There are many ways to contribute:\n\n"
            "• Code - fix bugs, add features, improve scripts\n"
            "• Design - UI/UX improvements, icons, wallpapers\n"
            "• Documentation - write guides, translate content\n"
            "• Testing - try new builds and report issues\n"
            "• Community - help other students in Discord\n\n"
            "No contribution is too small. Check our "
